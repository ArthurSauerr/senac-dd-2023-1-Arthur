...
public class TelaCadastroCliente {
	...
	private void initialize() {
		...
		frmTelaDeCadastramento.getContentPane().setBackground(new Color(192, 192, 192));
		...
		frmTelaDeCadastramento.getContentPane().setLayout(null);
			...
			formattedTxtCPF.setBounds(78, 54, 104, 20);
			...
			cbEndereco.setBounds(78, 93, 210, 22);
			...
			btnSalvar.setBounds(135, 167, 89, 23);
